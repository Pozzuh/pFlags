...
namespace Addon
{
    static class Extensions
    {
        ...
        private static readonly IntPtr JmpDestination = (IntPtr)0x4AFEC8;
        private static readonly IntPtr D3DBspEntsPointer = (IntPtr)0x17A1C54;
        private static readonly IntPtr MapNameDvarPointer = (IntPtr)0x57877B8;
        private static readonly IntPtr ScriptFailuireByteCheckAddress = (IntPtr)0x1CD5724;
        ...
        public static int FindAirdropCrateCollisionId()
        {
            try
            {
                IntPtr mapNameDvarAddress = Marshal.ReadIntPtr(MapNameDvarPointer);
